...
class TubeGrower(object):
    maxSolvebleRate = 0.1
    def __init__(self, circumferentialElements,axialElements,wallElements,discret=10,length=6,innerRadius=0.5,outerRadius=2,fixBottom=True,fixTop=False,DMBC=False,humphrey=False,neoHookean=False):
    ...
    def setupGrowthRates(self,growthElementRate):
        ...
        for elementNumber in range (1, numberOfElements+1):
            for gaussPointNumber in range (1,27+1):
                growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,gaussPointNumber,elementNumber,1,growthElementRate[elementNumber-1,0])
                growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,gaussPointNumber,elementNumber,2,growthElementRate[elementNumber-1,1])
                growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,gaussPointNumber,elementNumber,3,growthElementRate[elementNumber-1,2])
                growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,gaussPointNumber,elementNumber,4,growthElementRate[elementNumber-1,3])
                growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,gaussPointNumber,elementNumber,5,growthElementRate[elementNumber-1,4])
                growthCellMLParametersField.ParameterSetUpdateGaussPointDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,gaussPointNumber,elementNumber,6,growthElementRate[elementNumber-1,5])
    ...
    def solveAndGetSurfaceDescriptors(self,growthRate):
        ...
        growthElementRateDivided = growthRate/divi        
