...
class TubeGrower(object):
    maxSolvebleRate = 0.1
    def __init__(self, circumferentialElements,axialElements,wallElements,discret=10,length=6,innerRadius=0.5,outerRadius=2,fixBottom=True,fixTop=False,DMBC=True,humphrey=False,neoHookean=False):
